...
<body>
    <!-- page content -->
    <div class="header">
        <h1 class="page-title" value=''>Student <?php echo get_name($user_id) ?> result</h1>
    </div>
    <div class="content">
        <div class="box">
            ...
            <ul class="box-list">
                <?php
                $result_per_student_question = mysqli_query($connect, "SELECT question.question_title, question.question_id FROM student_answer, exam_question, question WHERE student_answer.question_id=exam_question.question_id AND question.question_id=exam_question.question_id AND student_answer.student_id=" . $user_id . " GROUP BY question.question_id");
                $result_per_student_selected_ans = mysqli_query($connect, "SELECT answer.answer_text FROM student_answer,answer WHERE student_answer.answer_id=answer.answer_id AND student_answer.student_id=" . $user_id . " ");
                $result_per_student_answer_score = mysqli_query($connect, "SELECT answer_score FROM student_answer WHERE student_answer.student_id=" . $user_id . " ");
        ...
        <div class="box">
            ...
            <ul class="box-list">
                <li class="box-item">
                    ...
                    <p class="subheading">
                        <?php
                        $result_per_student_total_score = mysqli_query($connect, "SELECT SUM(answer_score) FROM student_answer WHERE student_answer.student_id=" . $user_id . " ");
                ...
                <li class="box-item">
                    ...
                    <p class="subheading">
                        <?php
                        $result_per_student_submit_time = mysqli_query($connect, "SELECT time_submit FROM student_answer,student,student_exam WHERE student.student_id=student_exam.student_id AND student_answer.student_id=student.student_id AND student_answer.student_id=" . $user_id . " GROUP BY  student_answer.student_id");
